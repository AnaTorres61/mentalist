...
var tentativas = 3
var p = document.querySelector('.inform')
var entrada = document.getElementById('entrada')
var btVerificar = document.getElementById('btVerificar')


p.innerHTML = `Olá eu sou o Bot!👋<br>Você é capaz de adivinhar o número que estou pensando de 0 a 10 ???<br>⚠Você tem 3 tentativas!`
...
function verificar(){
    ...
    if(tentativas == 0){
        p.innerHTML = `Você Perdeu!!!(˘･_･˘) <br>O numero era ${numeroSecreto}.`
        entrada.value = ""
        entrada.disabled = true
        btVerificar.disabled = true
    }
